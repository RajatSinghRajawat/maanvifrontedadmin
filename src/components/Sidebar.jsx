      ...
      >
        <div className="h-full flex flex-col">
          <div className="px-6 py-6 border-b border-gray-200">
            <p className="text-xs uppercase tracking-wide text-gray-500">Mannvi</p>
            <p className="text-xl font-semibold text-gray-900">Admin Panel</p>
            <p className="text-sm text-gray-500">All-in-one control</p>
          </div>
